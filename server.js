...
mongoose.connect("mongodb://127.0.0.1:27017/explicacoes",{useNewUrlParser:true,useUnifiedTopology:true,})
...
server.listen(PORT1,()=>{
    console.log(`Servidor a correr em http://localhost:${PORT1}`)
})
