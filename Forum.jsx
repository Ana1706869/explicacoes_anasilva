...
const  Forum=()=>{
    ...
    const carregarMensagens=()=>{
        axios.get("http://localhost:9090/forum").then((res)=>{
    ...
    const enviarMensagens=async(e)=>{
        ...
        if(ficheiro) formData.append("ficheiro",ficheiro)
            ...
            await axios.post("http://localhost:9090/forum",formData,{
        ...
        <br/>
            ...
            {mensagensVisiveis.map((m,idx)=>(
                ...
                <p className="ficheiroForum">
                    Ficheiro:<a href={`http://localhost:9090/uploads/${m.ficheiro}`}download>{m.ficheiro}</a>
                </p>
                )}
                </div>
